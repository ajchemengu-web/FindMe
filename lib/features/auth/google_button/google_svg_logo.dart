/// Google's standard multi-color "G" mark, inlined so no network fetch or asset file
/// is needed. Used only on the native button -- the web button is Google's own
/// rendered widget, which already includes it.
