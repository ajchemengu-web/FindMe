              ...
              child: Column(
                ...
                children: [
                  ...
                  _field(
                    ...
                    _password,
                    hint:
                        'At least 10 characters, mixed case, a number & symbol',
                    obscure: true,
                  ),
                  if (_password.text.isNotEmpty) ...[
                        ...
                        return Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: active
                                  ? _strengthColors[strength.score]
                                  : AppColors.line,
                    ...
                    Text(
                      strength.label,
                      style: TextStyle(
                        color: _strengthColors[strength.score],
                        fontSize: 11,
                    ...
                    Text(
                      strength.issues.isEmpty
                          ? 'Meets every requirement.'
                          : strength.issues.join('  ·  '),
                      style: TextStyle(
                        color: strength.issues.isEmpty
                            ? AppColors.good
                            : AppColors.ink3,
                        fontSize: 10.5,
                        height: 1.3,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: _ack
                                  ...
                                  : Colors.transparent,
                              border: Border.all(
                                color: _ack ? AppColors.accent : AppColors.line,
                              ),
                          ...
                          const Expanded(
                            child: Text.rich(
                              TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: 'I understand FindMe can only track ',
                                  ),
                                  TextSpan(
                                    text: 'my own devices',
                                    style: TextStyle(
